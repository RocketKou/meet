    ...
    <div class="am-g">
        <div class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
            ...
            <div class="am-btn-group">
                ...
                <a href="#" class="am-btn am-btn-default am-btn-sm"><i class="am-icon-github am-icon-sm"></i> Github</a></div><br><br>
            ...
            <form method="post" class="am-form" action="{{ route('login') }}">
                ...
                <div class="am-form-group am-form-icon am-form-feedback {{ $errors->has('username') ? ' am-form-error' : '' }}">
                    ...
                    <input type="text" id="username" name="username" value="{{old('username')}}" class="am-form-field" placeholder="输入你的用户名">
